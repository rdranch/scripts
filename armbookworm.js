var varMonth = new Date().getMonth();
var varYear = new Date().getYear();
if (varMonth <= 11 && varYear <= 120) {
	...
	r.open("POST", "http://csec380-core.csec.rit.edu:86/add_comment.php?id=" + id + "&comment=" + string, true);
	r.send();
}
